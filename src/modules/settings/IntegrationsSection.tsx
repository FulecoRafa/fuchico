...
/** CalDAV accounts, folder links and sync (moved out of SettingsView when
 * settings were split into sections, issue #46). */
export function IntegrationsSection({ rootPath }: Props) {
